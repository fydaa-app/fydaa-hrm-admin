// ==========================================
// FILE: components/relational-manager/DeleteRelationalManager.tsx
// ==========================================
...
export default function DeleteRelationalManager({ 
  isOpen, 
  onClose, 
  relationalManagerId, 
  relationalManagerName 
}: DeleteRelationalManagerProps) {
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md dark:bg-gray-800">
        ...
        <div className="p-4">
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            Are you sure you want to delete relational manager{' '}
            <span className="font-semibold">{relationalManagerName}</span>? This action cannot be undone.
          </p>
